...
class BuyxinyiSpider(scrapy.Spider):
    ...
    taipei_city = [f"https://www.sinyi.com.tw/buy/list/Taipei-city/default-desc/{i}" for i in range(1, 345)]
    new_taipei_city = [f"https://www.sinyi.com.tw/buy/list/NewTaipei-city/default-desc/{i}" for i in range(1, 320)]
    keelong = [f"https://www.sinyi.com.tw/buy/list/Keelung-city/default-desc/{i}" for i in range(1, 107)]
    yilan_county = [f"https://www.sinyi.com.tw/buy/list/Yilan-county/default-desc/{i}" for i in range(1, 138)]
    hsinchu_city = [f"https://www.sinyi.com.tw/buy/list/Hsinchu-city/default-desc/{i}" for i in range(1, 46)]
    hsinchu_county = [f"https://www.sinyi.com.tw/buy/list/Hsinchu-county/default-desc/{i}" for i in range(1, 112)]
    taoyuan_city = [f"https://www.sinyi.com.tw/buy/list/Taoyuan-city/default-desc/{i}" for i in range(1, 847)]
    miaoli_county = [f"https://www.sinyi.com.tw/buy/list/Miaoli-county/default-desc/{i}" for i in range(1, 147)]
    taichung_city = [f"https://www.sinyi.com.tw/buy/list/Taichung-city/default-desc/{i}" for i in range(1, 844)]
    changhua_county = [f"https://www.sinyi.com.tw/buy/list/Changhua-county/default-desc/{i}" for i in range(1, 400)]
    nantou_county = [f"https://www.sinyi.com.tw/buy/list/Nantou-county/default-desc/{i}" for i in range(1, 70)]
    yunlin_county = [f"https://www.sinyi.com.tw/buy/list/Yunlin-county/default-desc/{i}" for i in range(1, 94)]
    chiayi_city = [f"https://www.sinyi.com.tw/buy/list/Chiayi-city/default-desc/{i}" for i in range(1, 62)]
    chiayi_county = [f"https://www.sinyi.com.tw/buy/list/Chiayi-county/default-desc/{i}" for i in range(1, 85)]
    tainan_city = [f"https://www.sinyi.com.tw/buy/list/Tainan-city/default-desc/{i}" for i in range(1, 700)]
    kaohsiung_city = [f"https://www.sinyi.com.tw/buy/list/Kaohsiung-city/default-desc/{i}" for i in range(1, 421)]
    pingtung_county = [f"https://www.sinyi.com.tw/buy/list/Pingtung-county/default-desc/{i}" for i in range(1, 187)]
    penghu_county = [f"https://www.sinyi.com.tw/buy/list/Penghu-county/default-desc/{i}" for i in range(1, 10)]
    taitung_county = [f"https://www.sinyi.com.tw/buy/list/Taitung-county/default-desc/{i}" for i in range(1, 63)]
